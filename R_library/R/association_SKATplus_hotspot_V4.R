...
doassocandwriteSKATPLUShotspot <- function (igene,
...
#      }
        #}
		  ...
		  rtnvar=c(genetest,testedRegionCoordinates,out$parameter[1],sum(varframebycase),dim(samplemetatablewithentity)[1],out$statistic,out$p.value,"N",paste(t(tmpdcast),collapse=" "))
