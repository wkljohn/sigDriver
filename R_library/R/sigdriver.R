  ...
  if (!is.na(testregions)) gns=genomic_bins_filter_whitelist(testregions,gns)
	...
	if (!is.na(context_file)){
		if (length(unique(sampleinfofiltered$entity)) == 1){
		    nullSKATmodel<-SKAT_Null_Model( log2(sampleinfofiltered$signature_variants + 1) ~  log2(sampleinfofiltered$A_C_A_A+1)+log2(sampleinfofiltered$A_C_A_C+1)+log2(sampleinfofiltered$A_C_A_G+1)+log2(sampleinfofiltered$A_C_A_T+1)+log2(sampleinfofiltered$C_C_A_A+1)+log2(sampleinfofiltered$C_C_A_C+1)+log2(sampleinfofiltered$C_C_A_G+1)+log2(sampleinfofiltered$C_C_A_T+1)+log2(sampleinfofiltered$G_C_A_A+1)+log2(sampleinfofiltered$G_C_A_C+1)+log2(sampleinfofiltered$G_C_A_G+1)+log2(sampleinfofiltered$G_C_A_T+1)+log2(sampleinfofiltered$T_C_A_A+1)+log2(sampleinfofiltered$T_C_A_C+1)+log2(sampleinfofiltered$T_C_A_G+1)+log2(sampleinfofiltered$T_C_A_T+1)+log2(sampleinfofiltered$A_C_G_A+1)+log2(sampleinfofiltered$A_C_G_C+1)+log2(sampleinfofiltered$A_C_G_G+1)+log2(sampleinfofiltered$A_C_G_T+1)+log2(sampleinfofiltered$C_C_G_A+1)+log2(sampleinfofiltered$C_C_G_C+1)+log2(sampleinfofiltered$C_C_G_G+1)+log2(sampleinfofiltered$C_C_G_T+1)+log2(sampleinfofiltered$G_C_G_A+1)+log2(sampleinfofiltered$G_C_G_C+1)+log2(sampleinfofiltered$G_C_G_G+1)+log2(sampleinfofiltered$G_C_G_T+1)+log2(sampleinfofiltered$T_C_G_A+1)+log2(sampleinfofiltered$T_C_G_C+1)+log2(sampleinfofiltered$T_C_G_G+1)+log2(sampleinfofiltered$T_C_G_T+1)+log2(sampleinfofiltered$A_C_T_A+1)+log2(sampleinfofiltered$A_C_T_C+1)+log2(sampleinfofiltered$A_C_T_G+1)+log2(sampleinfofiltered$A_C_T_T+1)+log2(sampleinfofiltered$C_C_T_A+1)+log2(sampleinfofiltered$C_C_T_C+1)+log2(sampleinfofiltered$C_C_T_G+1)+log2(sampleinfofiltered$C_C_T_T+1)+log2(sampleinfofiltered$G_C_T_A+1)+log2(sampleinfofiltered$G_C_T_C+1)+log2(sampleinfofiltered$G_C_T_G+1)+log2(sampleinfofiltered$G_C_T_T+1)+log2(sampleinfofiltered$T_C_T_A+1)+log2(sampleinfofiltered$T_C_T_C+1)+log2(sampleinfofiltered$T_C_T_G+1)+log2(sampleinfofiltered$T_C_T_T+1)+log2(sampleinfofiltered$A_T_A_A+1)+log2(sampleinfofiltered$A_T_A_C+1)+log2(sampleinfofiltered$A_T_A_G+1)+log2(sampleinfofiltered$A_T_A_T+1)+log2(sampleinfofiltered$C_T_A_A+1)+log2(sampleinfofiltered$C_T_A_C+1)+log2(sampleinfofiltered$C_T_A_G+1)+log2(sampleinfofiltered$C_T_A_T+1)+log2(sampleinfofiltered$G_T_A_A+1)+log2(sampleinfofiltered$G_T_A_C+1)+log2(sampleinfofiltered$G_T_A_G+1)+log2(sampleinfofiltered$G_T_A_T+1)+log2(sampleinfofiltered$T_T_A_A+1)+log2(sampleinfofiltered$T_T_A_C+1)+log2(sampleinfofiltered$T_T_A_G+1)+log2(sampleinfofiltered$T_T_A_T+1)+log2(sampleinfofiltered$A_T_C_A+1)+log2(sampleinfofiltered$A_T_C_C+1)+log2(sampleinfofiltered$A_T_C_G+1)+log2(sampleinfofiltered$A_T_C_T+1)+log2(sampleinfofiltered$C_T_C_A+1)+log2(sampleinfofiltered$C_T_C_C+1)+log2(sampleinfofiltered$C_T_C_G+1)+log2(sampleinfofiltered$C_T_C_T+1)+log2(sampleinfofiltered$G_T_C_A+1)+log2(sampleinfofiltered$G_T_C_C+1)+log2(sampleinfofiltered$G_T_C_G+1)+log2(sampleinfofiltered$G_T_C_T+1)+log2(sampleinfofiltered$T_T_C_A+1)+log2(sampleinfofiltered$T_T_C_C+1)+log2(sampleinfofiltered$T_T_C_G+1)+log2(sampleinfofiltered$T_T_C_T+1)+log2(sampleinfofiltered$A_T_G_A+1)+log2(sampleinfofiltered$A_T_G_C+1)+log2(sampleinfofiltered$A_T_G_G+1)+log2(sampleinfofiltered$A_T_G_T+1)+log2(sampleinfofiltered$C_T_G_A+1)+log2(sampleinfofiltered$C_T_G_C+1)+log2(sampleinfofiltered$C_T_G_G+1)+log2(sampleinfofiltered$C_T_G_T+1)+log2(sampleinfofiltered$G_T_G_A+1)+log2(sampleinfofiltered$G_T_G_C+1)+log2(sampleinfofiltered$G_T_G_G+1)+log2(sampleinfofiltered$G_T_G_T+1)+log2(sampleinfofiltered$T_T_G_A+1)+log2(sampleinfofiltered$T_T_G_C+1)+log2(sampleinfofiltered$T_T_G_G+1)+log2(sampleinfofiltered$T_T_G_T+1) + sampleinfofiltered$gender, out_type="C")#,n.Resampling=200,type.Resampling="bootstrap")
		  }else{
		    nullSKATmodel<-SKAT_Null_Model( log2(sampleinfofiltered$signature_variants + 1) ~ sampleinfofiltered$entity +  log2(sampleinfofiltered$A_C_A_A+1)+log2(sampleinfofiltered$A_C_A_C+1)+log2(sampleinfofiltered$A_C_A_G+1)+log2(sampleinfofiltered$A_C_A_T+1)+log2(sampleinfofiltered$C_C_A_A+1)+log2(sampleinfofiltered$C_C_A_C+1)+log2(sampleinfofiltered$C_C_A_G+1)+log2(sampleinfofiltered$C_C_A_T+1)+log2(sampleinfofiltered$G_C_A_A+1)+log2(sampleinfofiltered$G_C_A_C+1)+log2(sampleinfofiltered$G_C_A_G+1)+log2(sampleinfofiltered$G_C_A_T+1)+log2(sampleinfofiltered$T_C_A_A+1)+log2(sampleinfofiltered$T_C_A_C+1)+log2(sampleinfofiltered$T_C_A_G+1)+log2(sampleinfofiltered$T_C_A_T+1)+log2(sampleinfofiltered$A_C_G_A+1)+log2(sampleinfofiltered$A_C_G_C+1)+log2(sampleinfofiltered$A_C_G_G+1)+log2(sampleinfofiltered$A_C_G_T+1)+log2(sampleinfofiltered$C_C_G_A+1)+log2(sampleinfofiltered$C_C_G_C+1)+log2(sampleinfofiltered$C_C_G_G+1)+log2(sampleinfofiltered$C_C_G_T+1)+log2(sampleinfofiltered$G_C_G_A+1)+log2(sampleinfofiltered$G_C_G_C+1)+log2(sampleinfofiltered$G_C_G_G+1)+log2(sampleinfofiltered$G_C_G_T+1)+log2(sampleinfofiltered$T_C_G_A+1)+log2(sampleinfofiltered$T_C_G_C+1)+log2(sampleinfofiltered$T_C_G_G+1)+log2(sampleinfofiltered$T_C_G_T+1)+log2(sampleinfofiltered$A_C_T_A+1)+log2(sampleinfofiltered$A_C_T_C+1)+log2(sampleinfofiltered$A_C_T_G+1)+log2(sampleinfofiltered$A_C_T_T+1)+log2(sampleinfofiltered$C_C_T_A+1)+log2(sampleinfofiltered$C_C_T_C+1)+log2(sampleinfofiltered$C_C_T_G+1)+log2(sampleinfofiltered$C_C_T_T+1)+log2(sampleinfofiltered$G_C_T_A+1)+log2(sampleinfofiltered$G_C_T_C+1)+log2(sampleinfofiltered$G_C_T_G+1)+log2(sampleinfofiltered$G_C_T_T+1)+log2(sampleinfofiltered$T_C_T_A+1)+log2(sampleinfofiltered$T_C_T_C+1)+log2(sampleinfofiltered$T_C_T_G+1)+log2(sampleinfofiltered$T_C_T_T+1)+log2(sampleinfofiltered$A_T_A_A+1)+log2(sampleinfofiltered$A_T_A_C+1)+log2(sampleinfofiltered$A_T_A_G+1)+log2(sampleinfofiltered$A_T_A_T+1)+log2(sampleinfofiltered$C_T_A_A+1)+log2(sampleinfofiltered$C_T_A_C+1)+log2(sampleinfofiltered$C_T_A_G+1)+log2(sampleinfofiltered$C_T_A_T+1)+log2(sampleinfofiltered$G_T_A_A+1)+log2(sampleinfofiltered$G_T_A_C+1)+log2(sampleinfofiltered$G_T_A_G+1)+log2(sampleinfofiltered$G_T_A_T+1)+log2(sampleinfofiltered$T_T_A_A+1)+log2(sampleinfofiltered$T_T_A_C+1)+log2(sampleinfofiltered$T_T_A_G+1)+log2(sampleinfofiltered$T_T_A_T+1)+log2(sampleinfofiltered$A_T_C_A+1)+log2(sampleinfofiltered$A_T_C_C+1)+log2(sampleinfofiltered$A_T_C_G+1)+log2(sampleinfofiltered$A_T_C_T+1)+log2(sampleinfofiltered$C_T_C_A+1)+log2(sampleinfofiltered$C_T_C_C+1)+log2(sampleinfofiltered$C_T_C_G+1)+log2(sampleinfofiltered$C_T_C_T+1)+log2(sampleinfofiltered$G_T_C_A+1)+log2(sampleinfofiltered$G_T_C_C+1)+log2(sampleinfofiltered$G_T_C_G+1)+log2(sampleinfofiltered$G_T_C_T+1)+log2(sampleinfofiltered$T_T_C_A+1)+log2(sampleinfofiltered$T_T_C_C+1)+log2(sampleinfofiltered$T_T_C_G+1)+log2(sampleinfofiltered$T_T_C_T+1)+log2(sampleinfofiltered$A_T_G_A+1)+log2(sampleinfofiltered$A_T_G_C+1)+log2(sampleinfofiltered$A_T_G_G+1)+log2(sampleinfofiltered$A_T_G_T+1)+log2(sampleinfofiltered$C_T_G_A+1)+log2(sampleinfofiltered$C_T_G_C+1)+log2(sampleinfofiltered$C_T_G_G+1)+log2(sampleinfofiltered$C_T_G_T+1)+log2(sampleinfofiltered$G_T_G_A+1)+log2(sampleinfofiltered$G_T_G_C+1)+log2(sampleinfofiltered$G_T_G_G+1)+log2(sampleinfofiltered$G_T_G_T+1)+log2(sampleinfofiltered$T_T_G_A+1)+log2(sampleinfofiltered$T_T_G_C+1)+log2(sampleinfofiltered$T_T_G_G+1)+log2(sampleinfofiltered$T_T_G_T+1) + sampleinfofiltered$gender, out_type="C")#,n.Resampling=200,type.Resampling="bootstrap")
		  }
	}else{
		if (length(unique(sampleinfofiltered$entity)) == 1){
