...
sigDriver <- function(signature_test,
  ...
  if (!is.na(testregions)) gns=genomic_bins_filter_whitelist(testregions,gns)
    ...
    nullSKATmodel<-SKAT_Null_Model( sampleinfofiltered$normalized_exposures ~  sampleinfofiltered$total_variants + sampleinfofiltered$gender, out_type="C")#,n.Resampling=2000,type.Resampling="bootstrap")
  }else{
    ...
    nullSKATmodel<-SKAT_Null_Model( sampleinfofiltered$normalized_exposures ~ sampleinfofiltered$entity +    sampleinfofiltered$total_variants +  sampleinfofiltered$gender, out_type="C")#,n.Resampling=2000,type.Resampling="bootstrap")
  }
