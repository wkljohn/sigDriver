...
if (F){
	...
	#PCAWGE3 cat /b06x-isilon/b06x-c/chromothripsis/results/icgc/stratton_breast/mutSig/Publication_Master/Association/datafile/SBS_SBSE_linkinfo | awk '{print "qsub -l nodes=1:ppn=16 -l mem=40g -F \"-v /b06x-isilon/b06x-c/chromothripsis/results/icgc/stratton_breast/mutSig/Publication_Master/Mutation_catalogue/annovar/somatic_annotated_V2/merged.avout.hg19_multianno.nofilt.noartsnv.simple.gz -e /b06x-isilon/b06x-c/chromothripsis/software/sigProfiler/python_binary/for_testing/output/ICGC_VCF_ORG_E1_NOART_raw_exposure.tsv -m /b06x-isilon/b06x-c/chromothripsis/results/icgc/stratton_breast/mutSig/Publication_Master/Association/datafile/merged_pheno_tab.V3.noskin.tsv -s "$1" -E 0.04 -b \"SBS1,SBS5,SBS8\" -x \"Signature_EX5,Signature_EX6,Signature_EX10,Signature_EX14,Signature_EX15,Signature_EX17,Signature_EX18,Signature_EX21,Signature_EX22,Signature_EX24,Signature_EX25,Signature_EX27,Signature_EX28,Signature_EX29,Signature_EX31,Signature_EX33,Signature_EX34,Signature_EX35,Signature_EX36,Signature_EX37,Signature_EX39,Signature_EX40,Signature_EX8,Signature_EX16,Signature_EX26,Signature_EX4A,Signature_EX9,Signature_EX12,Signature_EX4B,Signature_EX23,Signature_EX3,Signature_EX30,Signature_EX38,Signature_EX2,Signature_EX32,Signature_EX41,Signature_EX20,Signature_EX19,Signature_EX1,Signature_EX7A,Signature_EX7B,Signature_EX13,Signature_EX11,"$2"\" -r /b06x-isilon/b06x-c/chromothripsis/results/icgc/stratton_breast/mutSig/Publication_Master/Association/datafile/SBSALL_whitelist_regions -o /b06x-isilon/b06x-c/chromothripsis/results/icgc/stratton_breast/mutSig/Publication_Master/Association/results/bin1k_cal_binbg1/ -t 16 \" run_sigdriver.R"}' | grep -v EX7
